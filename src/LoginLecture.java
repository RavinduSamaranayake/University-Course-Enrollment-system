 ...
 * @author USER
 */
public class LoginLecture extends javax.swing.JFrame {

    /**
     * Creates new form LoginLecture
     */
    Connection con = null;
        ...
        if(String.valueOf(pfield1.getPassword()).equals("")){
            ...
            try {
                ...
                if(rs.next()){
                    ...
                    LecturMain.test.setText("USER :"+fname + " " + lname);
                    LecturMain.lecid.setText(lecid);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginLecture.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LoginLecture().setVisible(true);
            }
        });
    }
